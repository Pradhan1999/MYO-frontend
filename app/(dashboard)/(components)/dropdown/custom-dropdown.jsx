    ...
    <div className="flex space-x-4">
      <DropdownMenu>
        ...
        <DropdownMenuContent className="w-56" align="start">
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem>
              <Icon icon="heroicons:user" className="w-3 h-3 mr-2 " />
              Profile
              <DropdownMenuShortcut>⇧⌘P</DropdownMenuShortcut>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Icon icon="heroicons:credit-card" className="w-3 h-3 mr-2 " />
              Billing
              <DropdownMenuShortcut>⌘B</DropdownMenuShortcut>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Icon icon="heroicons:cog-6-tooth" className="w-3 h-3 mr-2 " />
              Settings
              <DropdownMenuShortcut>⌘S</DropdownMenuShortcut>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Icon icon="ri:command-fill" className="w-3 h-3 mr-2 " />
              Keyboard shortcuts
          ...
          <DropdownMenuGroup>
            <DropdownMenuItem>
              <Icon icon="heroicons:user-group" className="w-3 h-3 mr-2 " />
              Team
            </DropdownMenuItem>
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>
                <Icon icon="heroicons:user-plus" className="w-3 h-3 mr-2 " />
                Invite users
              </DropdownMenuSubTrigger>
              <DropdownMenuPortal>
                <DropdownMenuSubContent>
                  <DropdownMenuItem>
                    <Icon icon="heroicons:envelope" className="w-3 h-3 mr-2 " />
                    Email
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Icon
            ...
            <DropdownMenuItem>
              <Icon icon="heroicons:plus" className="w-3 h-3 mr-2 " />
              New Team
          ...
          <DropdownMenuSeparator />
          <DropdownMenuItem>
            <Icon icon="heroicons:users" className="w-3 h-3 mr-2 " />
            GitHub
          </DropdownMenuItem>
          <DropdownMenuItem>
            <Icon
          ...
          <DropdownMenuItem disabled>
            <Icon icon="heroicons:cloud" className="w-3 h-3 mr-2 " />
            API
          </DropdownMenuItem>
          <DropdownMenuSeparator />
          <DropdownMenuItem>
            <Icon icon="heroicons:power" className="w-3 h-3 mr-2 " />
            Log out
