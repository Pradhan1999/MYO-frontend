export const routes = {
  trade: {
    addTrade: "/trades/add-trade",
    tradeLogs: "/trades",
    brokerSync: "/trades/broker-sync",
    tradeDetails: (id) => `/trades/${id}`,
  },
  reports: {
    overview: "/reports/overview",
    daytime: {
      days: "/reports/day-time/days",
      weeks: "/reports/day-time/weeks",
      months: "/reports/day-time/months",
      years: "/reports/day-time/years",
      tradeTime: "/reports/day-time/trade-time",
      tradeDuration: "/reports/day-time/trade-duration",
    },
    priceQuantity: {
      price: "/reports/price-quantity/price",
      instrument: "/reports/price-quantity/instrument",
      volume: "/reports/price-quantity/volume",
    },
  },
  settings: {
  ...
  eCommerce: {
    ...
    confirmOrder: "/ecommerce/orders/confirm",
  ...
  authentication: {
    ...
    setupPassword: (token) => `/authentication/setup-password/${token}`,
  },
};
